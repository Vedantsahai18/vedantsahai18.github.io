        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {filteredProjects.map((project, index) => (
            <motion.div
              ...
              whileTap={{ scale: 0.98 }}
              className="card-dark p-6 rounded-xl shadow-soft hover:shadow-hover transition-shadow duration-300 text-white group relative overflow-hidden cursor-pointer"
            >
              ...
              <div className="flex justify-center mt-4">
                <a
                  ...
                  className="btn-outline inline-flex items-center gap-2 text-white font-medium text-sm"
                >
